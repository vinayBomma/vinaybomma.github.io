    ...
    <header class="top-0 left-0 z-40 fixed w-full">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li>
            <a href="https://vinaybomma.hashnode.dev" target="_blank" class="text-copy-primary hover:text-gray-600" data-cypress="blog">Blog</a>
          </li>
        </ul>
      </nav>
    </header>
